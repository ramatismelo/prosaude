...
import com.example.myapplication.reports.Templates.CurrencyType;
...
public class Templates2 {
	...
	public static ComponentBuilder<?, ?> createTitleComponent(String label) {
		return cmp.horizontalList()
				.add(cmp.text("SOCIEDADE PRÓ-SAÚDE").setStyle(stl.style().bold().setFontSize(14)), 
						cmp.text(Utils.getSimpleDateFormat(new Date(), "dd/MM/yyyy HH:mm")).setStyle(stl.style()
