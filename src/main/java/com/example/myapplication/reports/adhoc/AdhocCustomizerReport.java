...
package com.example.myapplication.reports.adhoc;
...
import com.example.myapplication.reports.Templates;
...
public class AdhocCustomizerReport {
	...
	private void build() {
		...
		try {
			JasperPdfExporterBuilder pdfExporter = export.pdfExporter("c:\\temp-2018\\report-teste.pdf"); 
