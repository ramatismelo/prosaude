...
public class ValidateFieldInFilterEvent extends EventObject {
	...
	public ValidateFieldInFilterEvent(Object source) {
		super(source);
	}

	public interface ValidateFieldInFilterEventListener extends EventListener {
		public void onValidate(ValidateFieldInFilterEvent event);
	}
}
